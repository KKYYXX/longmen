...
Page({
  data: {
    ...
    projectColumns: [
      ...
      { name: '结对县（市、区）', key: 'pairedCounty', type: 'text', required: true, placeholder: '请输入结对县（市、区）' },
      { name: '组团结对高校院所', key: 'pairedInstitution', type: 'text', required: true, placeholder: '请输入组团结对高校院所' },
      { name: '项目名称', key: 'projectName', type: 'text', required: true, placeholder: '请输入项目名称' },
      { name: '项目实施单位（高校院所）', key: 'implementationUnit', type: 'text', required: true, placeholder: '请输入项目实施单位（高校院所）' },
      { name: '是否重点项目', key: 'isKeyProject', type: 'select', required:true, options: ['是', '否'] },
      { name: '涉及典型县镇村', key: 'involvedAreas', type: 'text', required: false, placeholder: '请输入涉及典型县镇村' },
      { name: '项目类型', key: 'projectType', type: 'select', required: true, options: ['强化产业发展科技支撑', '强化城乡规划建设服务', '突出基本公共服务支持', '突出基层人才培养培训', '参与集体经济运营', '参与基层改革创新探索','提供决策咨询服务'] },
      { name: '项目开始时间（按20xx.xx格式填入，如“2025.01”）', key: 'startDate', type: 'text', required: true, placeholder: '请选择项目开始时间' },
      { name: '项目结束时间（按20xx.xx格式填入，如“2025.01”）', key: 'endDate', type: 'text', required: true, placeholder: '请选择项目结束时间' },
      { name: '项目背景', key: 'background', type: 'textarea', required: true, placeholder: '请输入项目背景' },
